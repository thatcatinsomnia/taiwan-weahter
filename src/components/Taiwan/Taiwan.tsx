...
const records = weather.records.location;
...
export default function Taiwan({ cameraApi, ...delegated }: Props) {
  ...
  const changeActiveCityAndUpdateStyle = (newActiveCity: TMesh) => {
    ...
    newActiveCity.position.z = 0.06; // current.scale.z = scaleSize;
